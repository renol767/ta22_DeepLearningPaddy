...
# PARAMETERS #
fSpeed = 117/10 # Fordward Speed in cm/s (From Testing Experience) 11.7 cm / s
aSpeed = 360/10 # Angular Speed / Rotate, Degree/s
interval = 0.25
...
while True:
    ...
    img = np.zeros((1000, 1000, 3), np.uint8) # Create Blank black Image
